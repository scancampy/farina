          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">Manage Brand Data</h3>
                <div class="ml-auto p-3">
                  <a href="#" data-toggle="modal" id="btnaddbrand" data-target="#modalAddBrand" class="btn btn-primary btn-xs"><i class="nav-icon fas fa-plus"></i> Add New Brand</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
